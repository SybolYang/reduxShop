                ...
                <section className="container content-section">
                    ...
                    <div className="shop-items">
                        <div className="shop-item">
                            <img className="shop-item-image" src="images/01.webp" alt="01" />
                        ...
                        <div className="shop-item">
                            <img className="shop-item-image" src="images/02.webp" alt="01" />
                        ...
                        <div className="shop-item">
                            <img className="shop-item-image" src="images/03.webp" alt="01" />
                        ...
                        <div className="shop-item">
                            <img className="shop-item-image" src="images/04.webp" alt="01" />
